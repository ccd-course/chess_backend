...
public class MoveRight {
    ...
    public static Set<Move> concretise(Chessboard chessboard, Square fromSquare, boolean attack, boolean jump, boolean peaceful) {
        return right(chessboard, fromSquare, attack, jump, peaceful, -1);
    }
    ...
    public static Set<Move> right(Chessboard chessboard, Square fromSquare, boolean attack, boolean jump, boolean peaceful, int limit) {
